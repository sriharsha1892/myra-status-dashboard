...
// B2B Market Research themed loading messages
const LOADING_MESSAGES = [
  "Analyzing market trends...",
  "Segmenting customer data...",
  "Running regression analysis...",
  "Consulting our crystal ball (it's basically Excel)...",
  "Updating stakeholder presentations...",
  "Refreshing those pivot tables...",
              ...
              <div className="group">
                <div className="flex items-center justify-between mb-2">
                  <label htmlFor="password" className="block text-sm font-semibold text-gray-900 transition-colors group-focus-within:text-blue-600">
                    Password <span className="text-xs text-gray-500 font-normal italic">(psst... should probably have "myRA" in it)</span>
                  </label>
                  <button
                    type="button"
                ...
                <div className="relative">
                  <input
                    ...
                    required
                    disabled={loading}
                    className="w-full h-12 px-4 pr-12 text-sm text-gray-900 bg-white/50 backdrop-blur-sm border-2 border-gray-200 rounded-xl placeholder:text-gray-400
                             focus:outline-none focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 focus:bg-white
                             disabled:bg-gray-50 disabled:text-gray-500 disabled:cursor-not-allowed
                             transition-all duration-200 ease-out"
                  />
