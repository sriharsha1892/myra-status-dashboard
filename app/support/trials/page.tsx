            ...
            <>
              ...
              <div className="mb-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
                  ...
                  >
                    <div className="p-2 rounded-lg bg-accent-50 text-accent-600 group-hover:bg-accent-100 transition-colors duration-200">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-0.5">
                        <h4 className="text-sm font-semibold text-gray-900">Parse Text</h4>
                        <span className="text-[10px] font-medium text-accent-600 bg-accent-50 px-1.5 py-0.5 rounded">AI</span>
                      </div>
                      <p className="text-xs text-gray-500">Extract from emails &amp; notes</p>
                    </div>
