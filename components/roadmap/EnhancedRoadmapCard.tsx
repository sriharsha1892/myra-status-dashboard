...
export default function EnhancedRoadmapCard({ item, onLogTime, onClick }: EnhancedRoadmapCardProps) {
  ...
  return (
    <div
      className="group relative bg-white rounded-xl border border-slate-200 hover:border-blue-300 hover:shadow-lg transition-all duration-200 overflow-hidden"
    >
      {/* Stale indicator bar */}
      {isStale && (
        <div className={`absolute top-0 left-0 right-0 h-1 ${isVeryStale ? 'bg-red-500' : 'bg-orange-500'}`} />
      )}
        ...
        <div className="grid grid-cols-3 gap-3 mb-4">
          ...
          <div className="bg-slate-50 rounded-lg p-3 border border-slate-200">
            <div className="flex items-center gap-1.5 mb-1">
              ...
              <span className="text-xs text-slate-600 font-medium">Estimated</span>
            </div>
          ...
          <div className="bg-purple-50 rounded-lg p-3 border border-purple-200">
            <div className="flex items-center gap-1.5 mb-1">
              <TrendingUp className="w-3.5 h-3.5 text-purple-600" strokeWidth={2} />
