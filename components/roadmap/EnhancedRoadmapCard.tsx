    ...
    >
      ...
      <div className="p-3">
        ...
        <div className="grid grid-cols-3 gap-2 mb-2">
          ...
          <div className="bg-slate-50 rounded p-2 border border-slate-200">
            <div className="flex items-center gap-1 mb-0.5">
              ...
              <span className="text-[10px] text-slate-600 font-medium uppercase tracking-wide">Est</span>
            </div>
          ...
          <div className="bg-blue-50 rounded p-2 border border-blue-200">
            <div className="flex items-center gap-1 mb-0.5">
              ...
              <span className="text-[10px] text-blue-700 font-medium uppercase tracking-wide">Actual</span>
            </div>
          ...
          <div className="bg-purple-50 rounded p-2 border border-purple-200">
            <div className="flex items-center gap-1 mb-0.5">
              ...
              <span className="text-[10px] text-purple-700 font-medium uppercase tracking-wide">Prog</span>
            </div>
        ...
        <div className="flex items-center justify-between text-[11px] text-slate-600 mb-2">
          ...
          {/* Priority Badge */}
          <span className={`text-[10px] font-semibold ${getPriorityColor(item.priority)}`}>
        ...
        <div className="flex items-center justify-between pt-2 border-t border-slate-100">
          ...
          <button
            ...
            className="px-2.5 py-1 bg-gradient-to-r from-blue-600 to-purple-600 text-white text-[11px] font-medium rounded hover:from-blue-700 hover:to-purple-700 transition-all shadow-sm opacity-0 group-hover:opacity-100"
          >
            + Log Time
          </button>
        </div>
        ...
        {estimateVariance !== null && Math.abs(estimateVariance) > 25 && (
          <div className="mt-2 p-1.5 bg-amber-50 border border-amber-200 rounded flex items-center gap-1">
