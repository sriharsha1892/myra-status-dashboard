/**
 * Excel Organizations Bulk Import Modal
 *
...
interface BulkImportExcelOrganizationsModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSuccess: () => void;
}

export default function BulkImportExcelOrganizationsModal({
  isOpen,
  onClose,
  onSuccess,
}: BulkImportExcelOrganizationsModalProps) {
  // Create importer instance (memoized)
  const importer = useMemo(() => createExcelOrganizationsImporter(), []);
    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl max-w-5xl w-full max-h-[90vh] overflow-hidden flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-6">
          <BulkImportWizard
            title=""
            description="Upload an Excel file with organization and contact information. Required columns: Company Name, Email (Primary Contact). Optional: Sales POC, Domain, Title/Role, License dates."
            importer={importer}
