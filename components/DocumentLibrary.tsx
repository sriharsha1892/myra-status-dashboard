...
const COLOR_CLASSES: Record<string, {
  ...
  purple: {
    ...
    border: 'border-accent-200 hover:border-purple-400'
  },
  green: {
  ...
  slate: {
    ...
    border: 'border-neutral-200 hover:border-slate-400'
  },
  emerald: {
    ...
    return (
      <div className="flex items-center justify-center py-20">
        <div className="relative">
          <div className="w-16 h-16 border-4 border-accent-200 border-t-purple-600 rounded-full animate-spin" />
  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="fixed inset-0 -z-10 overflow-hidden">
        ...
        <div className="absolute bottom-0 right-0 w-[600px] h-[600px] bg-gradient-to-br from-accent-400/20 via-pink-400/20 to-blue-400/20 rounded-full blur-3xl animate-pulse animation-delay-1000" />
      ...
      <div className="relative z-10 space-y-8">
          ...
          <div className="relative backdrop-blur-xl bg-white/80 dark:bg-slate-900/60 border border-white/20 rounded-3xl p-8 shadow-2xl">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-4">
                <div className="p-3 rounded-2xl bg-gradient-to-br from-blue-500 to-accent-600 shadow-lg shadow-purple-500/50 animate-pulse">
                  <Sparkles className="w-8 h-8 text-white" />
                </div>
                <div>
                  <div className="relative inline-block">
                    <h1 className="text-3xl font-bold text-neutral-900 dark:text-white relative z-10">
                      Resource Library
                    </h1>
              ...
              <button
                ...
                className="flex items-center gap-2 px-6 py-3 rounded-xl bg-accent-500 text-white font-medium shadow-lg shadow-purple-500/30 hover:shadow-xl hover:shadow-purple-500/40 hover:scale-105 transition-all duration-300"
              >
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-3 rounded-xl backdrop-blur-sm bg-white/50 dark:bg-slate-800/50 border border-neutral-200/50 dark:border-slate-700/50 focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:border-transparent transition-all"
              />
            </div>
          </div>
        </div>
          ...
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2 rounded-xl font-medium transition-all duration-300 whitespace-nowrap ${
              selectedCategory === null
                ? 'bg-accent-500 text-white shadow-lg shadow-purple-500/30'
                : 'backdrop-blur-sm bg-white/60 dark:bg-slate-800/60 text-neutral-700 dark:text-slate-300 border border-neutral-200/50 hover:border-purple-500/50 hover:shadow-md'
            }`}
          >
              ...
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2 rounded-xl font-medium transition-all duration-300 whitespace-nowrap ${
                  isSelected
                    ...
                    : `backdrop-blur-sm bg-white/60 dark:bg-slate-800/60 text-neutral-700 dark:text-slate-300 border ${colorClass.border} hover:shadow-md`
                }`}
              >
        ...
        {filteredResources.length === 0 ? (
          <div className="text-center py-20">
            ...
            <h3 className="text-xl font-semibold text-neutral-700 dark:text-slate-300 mb-2">
              No resources found
            </h3>
      ...
      {trialOrgId && (
        <div className="fixed bottom-8 right-8 flex items-center gap-2 backdrop-blur-xl bg-white/80 dark:bg-slate-900/80 border border-white/20 rounded-2xl p-2 shadow-2xl">
          <button className="flex items-center gap-2 px-4 py-2 rounded-xl bg-accent-500 text-white text-sm font-medium shadow-lg">
            <Globe className="w-4 h-4" />
            Global
          </button>
          <button className="flex items-center gap-2 px-4 py-2 rounded-xl text-neutral-700 dark:text-slate-300 text-sm font-medium hover:bg-white/50 dark:hover:bg-slate-800/50 transition-colors">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl backdrop-blur-sm bg-white/50 dark:bg-slate-800/50 border border-neutral-200/50 dark:border-slate-700/50 focus:outline-none focus:ring-2 focus:ring-purple-500/50 transition-all"
