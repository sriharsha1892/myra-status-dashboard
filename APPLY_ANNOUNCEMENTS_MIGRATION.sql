...
-- Policy: Authenticated users can insert announcements
...
-- Policy: Authenticated users can update announcements
...
-- Policy: Authenticated users can delete announcements
...
-- =====================================================
-- MIGRATION COMPLETE
-- The announcements feature should now work!
-- =====================================================
